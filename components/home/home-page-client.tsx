...
export function HomePageClient({ wordCount }: HomePageClientProps) {
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      setHeroCount(Math.round(wordCount * eased));
        ...
        <section className="hero-wrap reveal" aria-label="Top page">
          <article className="paper-card hero-card">
            <div className="hero-content">
              ...
              <p className="hero-sub">英語の9割は、{formattedTotalCount}語でできている。</p>
